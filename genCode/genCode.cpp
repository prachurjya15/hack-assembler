...
string GenCode::Dest(string instruction) {
    return m_destMap[instruction];
}

string GenCode::Jump(string instruction){
    return m_jumpMap[instruction];
}
